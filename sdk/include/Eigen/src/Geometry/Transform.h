...
public:
  ...
  typedef Block<MatrixType,Dim,Dim,int(Mode)==(AffineCompact) && (int(Options) & int(RowMajor))==0> LinearPart;
  /** type of read reference to the linear part of the transformation */
  typedef const Block<ConstMatrixType,Dim,Dim,int(Mode)==(AffineCompact) && (int(Options) & int(RowMajor))==0> ConstLinearPart;
