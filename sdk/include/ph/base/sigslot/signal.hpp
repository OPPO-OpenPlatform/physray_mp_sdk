// This header is a modified copy of palacaze/sigslot library.
// Please check the CREDIT and LICENSE file in the same folder as where this header is for details.
...
// Prefix namespace with ph:: to avoid polluting global naming space.
namespace ph {
namespace sigslot {
...
public:
     ...
     */
    template<typename Pmf, typename Ptr>
    std::enable_if_t<trait::is_callable_v<arg_list, Pmf, Ptr> && !trait::is_observer_v<Ptr> && !trait::is_weak_ptr_compatible_v<Ptr>, connection>
